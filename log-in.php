...
<html lang="en">
  ...
  <form method="post" action="./includes/manage-user.inc.php" >
  <!-- Email input -->


  <div data-mdb-input-init class="form-outline mb-4">
    <input type="text" autocomplete="off" id="user_email_id" name="user_ref" class="form-control" />
  ...
  <?php
     session_start();
      ...
      if (isset($_SERVER['HTTP_REFERER']) && !isset($_SESSION['orSource'])) {
            $_SESSION['orSource'] = $_SERVER['HTTP_REFERER'];
       }
  ...
  <!-- Submit button -->
  <input type="submit" value="Sign in" onclick="clearQuery()" name="log_in_user" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4">
